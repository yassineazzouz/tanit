...
from ..master.server.test_server import master_server, user_client  # NOQA
...
class TestIntegration:
    ...
    def test_server_up(self, worker_server, user_client): # NOQA
        assert len(user_client.list_jobs()) >= 0

    def test_submit_job(self, worker_server, user_client): # NOQA
    ...
    def test_list_jobs(self, worker_server, user_client): # NOQA
